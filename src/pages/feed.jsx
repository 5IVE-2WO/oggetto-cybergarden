    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth={true}>
                <Box color='primary.black' sx={{width: "100%", display: "flex", justifyContent: "center", alignItem: "center"}}>
                    <DialogTitle>
                        Создание события
                    </DialogTitle>
                </Box>
                ...
                <DialogActions>
                    <Button sx={{color: 'primary.black'}} onClick={handleClose}>Создать</Button>
                </DialogActions>
            </Dialog>
